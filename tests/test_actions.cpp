...
class ActionPackTest : public ::testing::TestWithParam<std::tuple<ActionType, PlayerId, uint8_t, uint8_t>> {};
...
class ResourcePackTest : public ::testing::TestWithParam<std::tuple<Resource, uint8_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ResourcePackTest,
    ::testing::Values(
        std::make_tuple(Resource::Brick, 5),
...
class ArgumentPackTest : public ::testing::TestWithParam<std::tuple<uint8_t, uint8_t>> {};
