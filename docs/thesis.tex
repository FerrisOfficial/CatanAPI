...
\item Częstość zdobycia premii Najdłuższa Droga i Największa Armia: \\ Longest Road\% (LR\%) i Largest Army\% (LA\%)
...
W scenariuszu 2 zestawiono iteracje botów heurystycznych w układzie „poprzednik-następnik” w celu weryfikacji, czy kolejne modyfikacje heurystyk prowadzą do poprawy wyników również w bezpośrednim starciu z innymi wersjami (a nie wyłącznie przeciwko RandomPlayer). Oznaczenia: A - pierwszy bot starcia, B - drugi.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{scenario2_1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{scenario2_2.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ab_win_rate_progression.png}
\caption{Skuteczność AlphaBetaPlayer w zależności od jakości przeciwnika}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ab_tempo.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{ab_largest_army.png}
\caption{Częstotliwość zdobycia premii Największa Armia.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{ab_longest_road.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ab_production.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ab_dominance.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{orBot.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{road_effectiveness.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{road_longest_road.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{scenario4_all.png}
